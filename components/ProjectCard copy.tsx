...
import { Github as GithubIcon, Link2 as Link2Icon } from 'lucide-react'; // Updated icon import
    ...
    <Card className="group overflow-hidden relative">
      <CardHeader className="p-0">
        ...
        <div className="relative w-full h-[300px] flex items-center justify-center bg-tertiary
          dark:bg-secondary/40 xl:bg-work_project_bg-light
          ...
          <div className="flex gap-x-4">
            <Link href={project.link}
              className="bg-secondary w-[54px] rounded-full flex 
